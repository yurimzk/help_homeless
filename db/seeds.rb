...
User.create!(email: "anne@lewagon.com", password: "123456", first_name: "Anne", last_name: "Bortoli", address: "Rua José Bonifácio, 456 - Santa Teresa", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686319892/T02NE0241-U052YLW4TSM-ad36684f5b5f-512_wayoid.jpg")
User.create!(email: "ara@lewagon.com", password: "123456", first_name: "Araceli", last_name: "Gallardo", address: "Avenida das Lagoas, 789 - Barra da Tijuca", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686319900/T02NE0241-U05376AR3T8-298b08634e57-512_wqhlrf.jpg")
User.create!(email: "augusto@lewagon.com", password: "123456", first_name: "Augusto", last_name: "Lopes", address: "Rua Visconde de Itamarati, 321 - Botafogo", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686319921/T02NE0241-U052N41NB28-74bc3756b3a2-512_zrkd1j.png")
User.create!(email: "bruno@lewagon.com", password: "123456", first_name: "Bruno", last_name: "Fazz", address: "Avenida Nossa Senhora de Copacabana, 987 - Copacabana", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686319929/T02NE0241-U052L5PAFLJ-023414d20070-512_sqa0ot.jpg")
User.create!(email: "douglas@lewagon.com", password: "123456", first_name: "Douglas", last_name: "Passos", address: "Rua das Palmeiras, 654 - Flamengo", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686319935/T02NE0241-U053TTHUZDF-91b1ffa5ea9e-512_gj5o6d.jpg")
User.create!(email: "leo@lewagon.com", password: "123456", first_name: "Leonardo", last_name: "Alves", address: "Avenida Almirante Alexandrino, 2000 - Santa Teresa", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686254683/T02NE0241-U05426RHZDW-e6cf35666906-512_pwvhbs.jpg")
User.create!(email: "marcos@lewagon.com", password: "123456", first_name: "Marcos Gabriel", last_name: "Costa", address: "Rua do Lavradio, 543 - Lapa", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686319944/T02NE0241-U053V1TGS1X-4b8b3ad2aeb9-512_akcu73.jpg")
User.create!(email: "nemanja@lewagon.com", password: "123456", first_name: "Nemanja", last_name: "Trajkovic", address: "Avenida Infante Dom Henrique, 123 - Flamengo", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686319948/T02NE0241-U052Z7UJY6T-57621bac2b7f-512_d02e4c.jpg")
User.create!(email: "ph@lewagon.com", password: "123456", first_name: "Pedro Henrique", last_name: "Souza", address: "Rua Coronel Paulo Malta, 321 - Laranjeiras", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686254669/T02NE0241-U053DAFSZSL-c2ffe71d509e-512_mybcka.jpg")
User.create!(email: "pedro@lewagon.com", password: "123456", first_name: "Pedro", last_name: "Zoffoli", address: "Avenida Delfim Moreira, 789 - Leblon", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686254662/T02NE0241-U053DNHBUDQ-4e6311a803bf-512_w8jwlq.jpg")
User.create!(email: "yuri@lewagon.com", password: "123456", first_name: "Yuri", last_name: "Tagomori", address: "Rua Dias Ferreira, 456 - Leblon", profile_img: "https://res.cloudinary.com/dtz9smyye/image/upload/v1686254675/T02NE0241-U052K6YAR8S-99d65fe3873e-512_tjdm31.jpg")
...
Post.create!(content: "Count me in for bringing vegetables to the soup kitchen!", event_id: 1, user_id: 2)
Post.create!(content: "I heard about the food donation event, and I'd love to contribute.", event_id: 2, user_id: 3)
Post.create!(content: "Oh, I have some extra blankets lying around at home. I'd be more than happy to donate them for the event.", event_id: 3, user_id: 4)
Post.create!(content: "How can i help with it?", event_id: 4, user_id: 5)
Post.create!(content: "I will bring some clothes aswell.", event_id: 5, user_id: 6)
Post.create!(content: "Let's work together!", event_id: 6, user_id: 7)
Post.create!(content: "I really loved this idea!", event_id: 7, user_id: 8)
Post.create!(content: "Count me in for it!", event_id: 8, user_id: 9)
Post.create!(content: "I can definitely help with the event.", event_id: 9, user_id: 10)
Post.create!(content: "I will be there!", event_id: 10, user_id: 11)
Post.create!(content: "I believe that everyone deserves a chance to build stability in their lives.", event_id: 11, user_id: 1)

puts "Destroying all comments..."
Comment.destroy_all

puts "Creating new comments..."
Comment.create!(content: "I completely agree with you.", user_id: 3, post_id: 2)
Comment.create!(content: "I couldn't agree more!", user_id: 4, post_id: 3)
Comment.create!(content: "I share the same opinion. I agree with you.", user_id: 5, post_id: 4)
Comment.create!(content: "I really liked what you said!", user_id: 6, post_id: 5)
Comment.create!(content: "You've expressed exactly what I was thinking. I agree!", user_id: 7, post_id: 6)
Comment.create!(content: "I'm in complete agreement with what you said.", user_id: 8, post_id: 7)
Comment.create!(content: "I couldn't agree more with what you said.", user_id: 9, post_id: 8)
Comment.create!(content: "I'm so glad you shared that—I feel the same way!", user_id: 10, post_id: 9)
Comment.create!(content: "I'm completely on board with your point of view.", user_id: 11, post_id: 10)
Comment.create!(content: "I liked what you said.", user_id: 1, post_id: 11)
Comment.create!(content: "Loved that!", user_id: 2, post_id: 1)
Comment.create!(content: "I'm more than willing to help!", user_id: 3, post_id: 2)
Comment.create!(content: "Count me in—I'm here to lend a hand.", user_id: 4, post_id: 3)
Comment.create!(content: "I'm fully prepared to lend my help and support.", user_id: 5, post_id: 4)
Comment.create!(content: "I'm here and ready to help out with whatever is needed.", user_id: 6, post_id: 5)
Comment.create!(content: "I'm eager to be of assistance in any way I can.", user_id: 7, post_id: 6)
Comment.create!(content: "I'll gladly contribute my support.", user_id: 8, post_id: 7)
Comment.create!(content: "I'm committed to helping and making a difference.", user_id: 9, post_id: 8)
Comment.create!(content: "I'm ready and available to offer my help.", user_id: 10, post_id: 9)
Comment.create!(content: "Loved what you said.", user_id: 11, post_id: 10)
Comment.create!(content: "I agree, and I'm more than willing to help!", user_id: 1, post_id: 11)
Comment.create!(content: "I completely agree with what you said, and I'm committed to helping.", user_id: 2, post_id: 1)
